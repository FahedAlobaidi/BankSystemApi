...
{
    public class GetClientControllerTest: IClassFixture<WebApplicationFactory<IApiMarker>>, IAsyncLifetime
    {
        //arrange
        ...
        public GetClientControllerTest(WebApplicationFactory<IApiMarker> appFactory)
        {
